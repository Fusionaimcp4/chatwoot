...
<template>
  <div
    class="items-center flex ltr:pl-3 rtl:pr-3 ltr:pr-2 rtl:pl-2 rounded-full transition-all duration-200 bg-transparent outline outline-1 outline-offset-[-1px] outline-n-weak"
    :class="{
      'outline-n-strong': isFocused,
...
.user-message-input {
  @apply border-none outline-none w-full placeholder:text-n-slate-10 resize-none h-10 min-h-10 max-h-60 py-2 px-0 my-2 bg-transparent text-n-slate-12 transition-all duration-200;
}
</style>
